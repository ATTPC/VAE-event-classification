...
for i in range(num_simulations):
    ...
    T, state_size, latent_dim, loss_type, rw_type, n_enc, n_dec, beta, eta, epochs = (
        hp_gen.generate_config()
    )
    hyperparam_vals.append(
        [T, state_size, latent_dim, loss_type, rw_type, n_enc, n_dec, beta]
    )
    ...
    np.save(
        "../loss_records/arch_hyperparam_vals_{}.npy".format(RUN_COUNT), hyperparam_vals
    )
